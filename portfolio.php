...
?>
    <main>
        ...
        <p><a href="portfolio.html" class="display">Sérieusement ?</a></p>

        <p>Bon ça va, ça va...je suis un jeune homme introverti et calme, certes un peu colérique et trèèèès obstiné mais la situation est sous contrôle (je l'espère en tout cas) ! J'adore faire des blagues et je suis plutôt altruiste / empathique aussi. Et un grand romantique dans l'âme... ;p<br>
        ...
        <p><a href="portfolio.html" class="display">...</a></p>
        ...
        <p><a href="grotte.html">Quoi qu'il en soit, suivez moi, je vous montre ma grotte secrète.</a></p>

        <h2><strong>Et comment on peut te contacter (si quelqu'un voudrait éventuellement le faire) ?</strong></h2>

        <p>...</p>
        <p>Vous me faites mal...ça brise mon petit coeur de pierre...mais soit ! Heureusement que c'était votre dernière question ! Pour me contacter, <a href="contact.html">c'est par là !</a></p>
    </main>
